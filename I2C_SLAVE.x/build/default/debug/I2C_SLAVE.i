...
;-------------------------------------------------------------------------------
    ...
    BTFSS SSPSTAT,0 ;Wait until ((SSPSTAT) and 07Fh), 0 is set
    GOTO $-1 ;((ADCON0) and 07Fh), 1 back 1 line

    BCF STATUS,5 ;Set ((STATUS) and 07Fh), 5 to 0
    BCF STATUS,6 ;Set ((STATUS) and 07Fh), 6 to 0

    BTFSS PIR1,3 ;Wait until ((PIR1) and 07Fh), 3 is set
    GOTO $-1 ;((ADCON0) and 07Fh), 1 back 1 line
    ...
    BTFSC SSPSTAT,0 ;Wait unitl ((SSPSTAT) and 07Fh), 0 goes low
    GOTO $-1 ;((ADCON0) and 07Fh), 1 back 1 line
    ...
    BTFSC PIR1,3 ;Wait until ((PIR1) and 07Fh), 3 is set
    GOTO $-1 ;((ADCON0) and 07Fh), 1 back 1 line
...
;---SERVO_3---------------------------------------------------------------------
    ...
    GOTO MAIN ;Loop back to MAIN program
